Attribute VB_Name = "MxDtaSqStr"
Option Explicit
Option Compare Text
Const CLib$ = "QDta."
Const CMod$ = CLib & "MxDtaSqStr."

Function SqStr$(Sq())
':SqStr: :S  ! it is Lines of CellStr Ln.
'            ! #CellStr-Ln is :CellStr separaterd by vbTab with ending vbTab.
'            ! the fst CellStr-Ln will not trim the ending vbTab, because it is used to determine how many col.
'            ! if any non-Lin1-CellStr-Ln has more fld than lin1-CellStr-Ln-fld, the extra fld are ignored and inf (this is done in %SqS%
