Attribute VB_Name = "MxIdeMdOpSrt"
Option Explicit
Option Compare Text
Const CLib$ = "QIde."
Const CMod$ = CLib & "MxIdeMdSrt."
...
Sub SrtMdzSrcPth(SrcPth)
Dim P$: P = EnsPthSfx(SrcPth)
Dim F: For Each F In Ffny(P, "*.bas")
...
SrtdSrcl = LineszLinesDic(SrtDic(MthlDic(Src)), vb2CrLf)
End Function
