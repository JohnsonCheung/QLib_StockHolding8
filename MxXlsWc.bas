Attribute VB_Name = "MxXlsWc"
Option Explicit
Option Compare Text
Const CLib$ = "QXls."
Const CMod$ = CLib & "MxXlsWc."
...
Function WColnoyzWb(A As Workbook) As String()
WColnoyzWb = Itn(A.Connections)
End Function
...
Sub SetWczFb(A As WorkbookConnection, Fb)
If IsNothing(A.OLEDBConnection) Then Exit Sub
Dim Cn$
#Const A = 2
#If A = 1 Then
