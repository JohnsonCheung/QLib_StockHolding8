Attribute VB_Name = "MxVbDtaMaybe"
Option Compare Text
Option Explicit
Const CLib$ = "QVb."
Const CNs$ = "Dta"
Const CMod$ = CLib & "MxVbDtaMaybe."
...
Type IntOpt:  Som As Boolean: I As Integer:      End Type
...
Function SomInt(I) As IntOpt:                 SomInt.Som = True:  SomInt.I = I:     End Function
