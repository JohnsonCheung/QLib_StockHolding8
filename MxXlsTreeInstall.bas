Attribute VB_Name = "MxXlsTreeInstall"
Option Compare Text
Option Explicit
Const CLib$ = "QXls."
Const CMod$ = CLib & "MxXlsTreeInstall."
Function TreeWsMdLnes$()
Erase XX
X "Option Explicit"
...
Const CSub$ = CMod & "InstallTreeWsz"
Dim Md As CodeModule
Set Md = MdzWs(A)
Stop
If Md.CountOfLines = 0 Then
    Md.AddFromString TreeWsMdLnes
    InfLn CSub, "TreeWs in Wb is installed with code", "Wb", WbnzWs(A)
Else
    InfLn CSub, "TreeWs in Wb already has code", "Wb", WbnzWs(A)
End If
End Sub
