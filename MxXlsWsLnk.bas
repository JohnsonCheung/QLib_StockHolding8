Attribute VB_Name = "MxXlsWsLnk"
Option Compare Text
Option Explicit
Const CLib$ = "QXls."
Const CMod$ = CLib & "MxXlsWsLnk."
...
If R.HypErLnks.Count > 0 Then Debug.Print "Som cell has HypLnk in Rg[" & R.Address & "]": Exit Sub 'Exit=>

'== Fill in Wsn / Go / CrtHypLnk =======================================================================================
Set R = At
Dim Wsn: For Each Wsn In W
    If Not IsEmpty(R.Value) Then Imposs CSub ' The IsVdt is not OK
        R.Value = Wsn              ' <== Set Wsn
          Set R = RgRC(R, 1, 0)
        R.Value = "Go"             ' <== Set Go
