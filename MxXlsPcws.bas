Attribute VB_Name = "MxXlsPcws"
Option Explicit
Option Compare Text
Const CLib$ = "QXls."
Const CMod$ = CLib & "MxXlsPcws."
...
Dim ChdDy(), KeyDy()
    ...
    Dim ChdColnoy%(): ChdColnoy = Cxy(SrcFny, ChdFny)
    Dim KeyColnoy%(): KeyColnoy = Cxy(SrcFny, KeyFny)
    ChdDy = DyzSqColnoy(SrcSq, ChdColnoy)
    KeyDy = DyzSqColnoy(SrcSq, KeyColnoy)
