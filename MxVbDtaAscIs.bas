Attribute VB_Name = "MxVbDtaAscIs"
Option Compare Text
Option Explicit
Const CLib$ = "QVb."
Const CNs$ = "Asc"
Const CMod$ = CLib & "MxVbDtaAscIs."
...
Function IsPun(S$) As Boolean
If IsLetter(S) Then Exit Function
If IsDigit(S) Then Exit Function
If S = vbCr Then Exit Function
If S = vbLf Then Exit Function
If S = "_" Then Exit Function
IsPun = True
End Function

Function IsDigit(S$) As Boolean
IsDigit = IsAscDigit(Asc(S))
End Function

Function IsLCas(S$)
IsLCas = IsAscLCas(Asc(S))
End Function

Function IsUCas(S$)
IsUCas = IsAscUCas(Asc(S))
End Function
