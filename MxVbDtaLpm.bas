Attribute VB_Name = "MxVbDtaLpm"
Option Explicit
Option Compare Text
Const CLib$ = "QVb."
Const CNs$ = "Dta"
Const CMod$ = CLib & "MxVbDtaLpm."

Function Lpm(PmStr$, LpmSpec$) As Dictionary
':Lpm: :Dic ! #Line-Parameter# It is a dic
...
Sub PushPmNm(Lpm As Dictionary, PmNm$)
...
Function HasSw(Lpm As Dictionary, SwNm) As Boolean
HasSw = HasEle(LpmSwNy(Lpm), SwNm)
End Function
...
Next
FmtLpm = AliLyzSepss(O, "ValCnt Val(")
End Function
